...
const Footer = () => {
    ...
    return (
        <footer >
            <div className="footer p-10 bg-[#D1D1E9] text-base-content">
                <div>
                    ...
                    <p className="font-semibold"><span className="text-[#FF4667] font-bold">e</span><span className="text-[#6246EA] font-bold">Speak</span><br />Providing reliable service since 2010</p>
                </div>
                <div>
                    <span className="footer-title text-[#6246EA]">Services</span>
                ...
                <div>
                    <span className="footer-title text-[#6246EA]">Company</span>
                ...
                <div>
                    <span className="footer-title text-[#6246EA]">Legal</span>
                    <a className="link link-hover">Terms of use</a>
                    <a className="link link-hover">Privacy policy</a>
                    <a className="link link-hover">Cookie policy</a>
                </div>
                <div>
                    <span className="footer-title text-[#6246EA]">Newsletter</span>
            ...
            <footer className="footer footer-center p-4 bg-[#D1D1E9] text-base-content">
                <div>
                    <p className="font-semibold">Copyright © {year} - All right reserved by eSpeak</p>
                </div>
            </footer>
        </footer>
    );
