...
const Footer = () => {
    ...
    return (
        <footer className="mt-32">
            <div className="footer p-10 bg-[#E7EFFC] text-base-content">
                <div>
                    ...
                    <p className="font-semibold"><span className="text-[#FF4667] font-bold">e</span><span className="text-[#254372] font-bold">Speak</span><br />Providing reliable service since 2010</p>
                </div>
                <div>
                    <span className="footer-title text-[#254372]">Services</span>
                ...
                <div>
                    <span className="footer-title text-[#254372]">Company</span>
                ...
                <div>
                    <span className="footer-title text-[#254372]">Legal</span>
                    <a className="link link-hover">Terms of use</a>
                    <a className="link link-hover">Privacy policy</a>
                    <a className="link link-hover">Cookie policy</a>
                </div>
                <div>
                    <span className="footer-title text-[#254372]">Newsletter</span>
            ...
            <footer className="footer footer-center p-4 bg-[#E7EFFC] text-base-content">
                <div>
